...
public class ImportedNumbers
{
    ...
    public Task<Dictionary<string, object?>> CreateAsync(string number, string numberType, List<object?>? capabilities = null, Dictionary<string, object?>? extras = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
    {
