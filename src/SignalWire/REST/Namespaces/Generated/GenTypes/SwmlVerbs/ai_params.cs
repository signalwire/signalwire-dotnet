...
/// <summary>
/// AIParams — generated method-less data type (schema.json $defs schema 'AIParams').
///
...
public class AIParams
{
    ...
    public List<SignalWire.Core.SwmlVerbsGenerated.ConversationMessage>? convo { get; set; }
    ...
    public Dictionary<string, object?>? pom_format { get; set; }
