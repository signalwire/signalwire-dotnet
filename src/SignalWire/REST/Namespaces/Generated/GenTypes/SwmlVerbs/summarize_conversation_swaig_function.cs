...
/// <summary>
/// SummarizeConversationSWAIGFunction — generated method-less data type (schema.json $defs schema 'SummarizeConversationSWAIGFunction').
///
...
public class SummarizeConversationSWAIGFunction
{
    ...
    public SignalWire.Core.SwmlVerbsGenerated.FunctionParameters? argument { get; set; }
