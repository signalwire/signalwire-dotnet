...
/// <summary>
/// AIPromptPom — generated method-less data type (schema.json $defs schema 'AIPromptPom').
///
...
public class AIPromptPom
{
    ...
    public SignalWire.Core.SwmlVerbsGenerated.Contexts? contexts { get; set; }
}
