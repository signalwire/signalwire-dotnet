...
/// <summary>
/// ResourceResponseSipGateway — generated method-less data type ('fabric' spec components/schemas 'ResourceResponseSipGateway').
///
...
/// </summary>
public class ResourceResponseSipGateway
{
    ...
    public Dictionary<string, object?>? sip_gateway { get; set; }
}
