...
public class Messages
{
    ...
    /// <param name="extras">Forward-compat body fields merged onto the request.</param>
    /// <param name="requestOptions">Per-call request options (timeout/retries/abort) overriding the client defaults.</param>
    public Task<Dictionary<string, object?>> UpdateAsync(string messageId, string body, Dictionary<string, object?>? extras = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
    {
        var _reqBody = new Dictionary<string, object?>();
        _reqBody["body"] = body;
        if (extras is not null)
        ...
        return Client.PatchAsync(Path(messageId), _reqBody, requestOptions: requestOptions, cancellationToken: cancellationToken);
    }
}
