...
signalwire.core.function_result.FunctionResult.remove_global_data: .NET RemoveGlobalData takes List<string> for keys; Python accepts either str or List[str] - a documented convenience-shape divergence (the list form is the common case)
signalwire.core.function_result.FunctionResult.remove_metadata: .NET RemoveMetadata takes List<string> for keys; Python accepts either str or List[str] - a documented convenience-shape divergence (the list form is the common case)
