...
signalwire.core.function_result.FunctionResult.remove_metadata: .NET helpers take List<string> for keys; Python accepts either str or List[str] - both shapes are convenience overloads
