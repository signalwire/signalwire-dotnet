...
//
// Demonstrates using SignalWire.SWML.Service directly to create and serve SWML
...
var voicemail = new Service(new ServiceOptions { Name = "voicemail", Route = "/voicemail" });

voicemail.AddVerb("answer", new Dictionary<string, object>());
...
var ivr = new Service(new ServiceOptions { Name = "ivr", Route = "/ivr" });

ivr.AddVerb("answer", new Dictionary<string, object>());
...
var transfer = new Service(new ServiceOptions { Name = "transfer", Route = "/transfer" });

transfer.AddVerb("answer", new Dictionary<string, object>());
